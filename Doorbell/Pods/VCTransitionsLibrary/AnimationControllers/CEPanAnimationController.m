...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext fromVC:(UIViewController *)fromVC toVC:(UIViewController *)toVC fromView:(UIView *)fromView toView:(UIView *)toView {
    ...
    toView.frame = CGRectMake(self.reverse ? -toVC.view.frame.size.width/2 : toVC.view.frame.size.width, toView.frame.origin.y, toView.frame.size.width, toView.frame.size.height);
    ...
    [UIView animateWithDuration:duration animations:^{
        fromView.frame = CGRectMake(!self.reverse ? -toVC.view.frame.size.width/2 : toVC.view.frame.size.width, fromView.frame.origin.y, fromView.frame.size.width, fromView.frame.size.height);
